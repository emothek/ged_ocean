...
app.use(
  cors({
    origin: [
      "*",
      "https://stingray-app-r5jip.ondigitalocean.app",
      "http://stingray-app-r5jip.ondigitalocean.app",
      "http://localhost:3000",
    ],
    credentials: true,
  })
...
app.use(
  session({
    name: "prisma-auth-test",
    secret: "prisma@Ged",
    saveUninitialized: false,
    resave: false,
    cookie: { maxAge: "2d" * 24 * 24 * 60 * 1000 },
  })
);
...
app.use(cookies("jhdshhds884hfhhs-ew6dhjd"));
